...
<div class="entry current">
  ...
  <ul>
    <li>Schwerpunkt: quantitative Ungleichheitsforschung</li>
  </ul>
</div>
...
<div class="entry">
  ...
  <div class="role">Auslandsjahr, B.A. Soziologie und B.Sc. Informatik (Note 2,9 / 4,0) — Singapur</div>
  <ul>
    <li>PROMOS-Stipendium des Bundesministeriums für Bildung und Forschung und des DAAD</li>
    <li>Schwerpunkte: Big Data Analytics, Soziale Netzwerke und fortgeschrittene Methoden der Datenanalyse</li>
  </ul>
</div>
...
<div class="entry">
  ...
  <ul>
    <li>Auslandsjahr an der Scranton High School (USA) und kurzer Austausch an der Oundle School (UK)</li>
  </ul>
</div>
...
<div class="entry">
  ...
  <div class="role">Studentische Hilfskraft, Survey Design and Methodology — Mannheim</div>
  <ul>
    <li>Mitarbeit beim Aufbau des GESIS-Puls-Panels mit Verknüpfung von digitalen Verhaltensdaten und Umfragedaten</li>
    <li>Entwicklung von Umfrage-Items und Testen der Fragebogenlogik in Pre-Test-Phasen</li>
    <li>Umsetzung gezielter digitaler Werbekampagnen zur Steigerung der Teilnahme</li>
  </ul>
</div>
